...
public class CommonTwo {
    ...
    public static void saveCustomer(Context context, String customer) {
        SharedPreferences preferences =
                context.getSharedPreferences("customer", MODE_PRIVATE);
        preferences.edit().putString("customerName", customer).apply();
    }

    public static String loadCustomer(Context context) {
        SharedPreferences preferences =
                context.getSharedPreferences("customer", MODE_PRIVATE);
