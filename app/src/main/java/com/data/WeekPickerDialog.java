...
//    private final static String PREFERENCES_NAME = "preferences";
    ...
    public WeekPickerDialog(Context context, int themeResId, Calendar calendar, OnWeekSelectListener listener ) {
        ...
        initPickerView();
        setView(view);
        setButton(BUTTON_POSITIVE, themeContext.getString(R.string.textOk), this);
        setButton(BUTTON_NEGATIVE, themeContext.getString(R.string.textNo), this);
        setButton(BUTTON_NEUTRAL, themeContext.getString(R.string.textClear),this);
    }
    ...
    private void initPickerView(){
        ...
        yearPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                Log.d("TAGBYEARSonValueChange", "TAGBYEARSonValueChangeoldVal" + oldVal  +"\nTAGBYEARSonValueChangenewVal" + newVal);
                selectYearIndex = newVal;
                 yearNumber = newVal + 2017;
        ...
        weekPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            @Override
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                Log.d("TAGBSonValueChange", "onValueChangeoldVal" + oldVal  +"\nonValueChangenewVal" + newVal);
                weekNumber =  newVal + 1;
            }
        });
    }
